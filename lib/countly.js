    ...
    var CountlyClass = function(ob) {
        ...
        * */
        ...
        function sendEventsForced() {
          // process event queue, create requests
        ...
        function onRequestFinished(err, parameters) {
        ...
        function sendRequests() {
          // do not try to send another request if one is currently in progress.
          // if we have more requests queued then another send operation will be launched
          // from onRequestFinished
          if (!sendingRequest) {
            // send request queue until it is empty
            if (
                !offlineMode &&
